...
//	private static final int MAX_FRAME_HEIGHT = 756; // = 7/10 * 1080
//
...
//			height = (int)(width);
//			LogMgr.d("height=="+height);
//			int leftOffset = (screenResolution.x - width) / 2;
//			int topOffset = (screenResolution.y - height- height/3) / 2;
...
//			return hardMax;
//		}
//		LogMgr.d("resolution=="+resolution+",dim=="+dim);
//		return dim;
//	}
//
//	/**
